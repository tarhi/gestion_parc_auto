...
class parc_autos(base):
    __tablename__ = 'car_table'
    id = Column(Integer, primary_key=True)
    marque = Column(String(50), nullable=False)
    matricule_enregistrer = Column(String(50),nullable=False)
...
class client(base):
    ...
    n_permis_conduit = Column(String(50), nullable=False)
...
class entretiens(base):
    ...
    date_entretien = Column(String(10), nullable=False)
