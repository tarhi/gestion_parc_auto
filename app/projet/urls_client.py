...
from app.projet.models import client
...
@app.get('/client/',dependencies=[Depends(JWTbearer())], tags=["Base clients"])
...
@app.delete('/client/{id}',dependencies=[Depends(JWTbearer())],status_code=status.HTTP_204_NO_CONTENT, tags=["Base clients"])
